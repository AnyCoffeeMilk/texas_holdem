...
export default function Opponent({ info, inTurn, flipCard, blindTag }) {
  return (
    <div className="relative grid min-w-[10.25rem] grid-cols-1 grid-rows-[auto_auto] gap-1 lg:grid-cols-[1fr_auto] lg:grid-rows-[1fr_auto_auto]">
      ...
      <div className="col-2 row-1 grid grid-cols-[1.5rem_1fr] gap-1 text-[0.7em] sm:text-[0.81em] lg:col-2 lg:row-1 lg:flex lg:text-[0.98em]">
